...
def analyze_certificate(hostname):
    try:
        ...
        if is_secure:
            print(f"SECURITY ASSESSMENT: The website {hostname} appears to be SECURE.")
            print("It should be safe to enter your data and navigate on this site.")
        else:
            print(f"SECURITY ASSESSMENT: The website {hostname} may NOT BE SECURE.")
        ...
        print(f"SSL Error: Unable to establish a secure connection to {hostname}")
        print(f"Details: {str(e)}")
    except socket.gaierror:
        print(f"Error: Unable to resolve hostname {hostname}")
    except socket.error as e:
        print(f"Connection Error: Unable to connect to {hostname}")
        print(f"Details: {str(e)}")
    except Exception as e:
        print(f"Unexpected error analyzing the certificate: {str(e)}")
